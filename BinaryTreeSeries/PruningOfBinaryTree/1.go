...
func PruningOfBinaryTree(root *Tree) *Tree{

	if root == nil {
		return nil
	}
		root.Left =PruningOfBinaryTree(root.Left)
		root.Right =PruningOfBinaryTree(root.Right)
	if root.Data.(int) == 0 && root.Left == nil && root.Right == nil{
			return nil
	}
...
func main(){
	...
	PreOrder(PruningOfBinaryTree(root))
